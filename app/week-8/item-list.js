...
export default function ItemList({ items = [], onItemSelect }) { // Provide a default value for items
  ...
  useEffect(() => {
    const sortItems = (items) => {
      ...
      if (sortBy === "name") {
        ...
        sorted.sort((item1, item2) => item1.category.localeCompare(item2.category));
      }
